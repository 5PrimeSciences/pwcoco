...
int initial_coloc(phenotype *exposure, phenotype *outcome, std::string out, double p1, double p2, double p3,
                  double init_h4);
int pwcoco_sub(phenotype *exposure, phenotype *outcome, reference *ref, double p_cutoff1, double p_cutoff2,
               double collinear, double ld_window, std::string out, double top_snp, double freq_threshold,
               double cond_ssize, bool out_cond, double p1, double p2, double p3, bool verbose);
